...
(a)  Write out the complete nonlinear programming model filling in the constants but leaving $B$ unspecified for now.
...
The sales department indicates that the sales potential for products 1 and 2 exceeds the maximum production rate and that the sales potential for product 3 is 20 units per week.  The firm encounters pricep elasticity in selling the three products.  In particular, suppose that
the unit costs for producing products 1, 2, and 3 are \$25, \$10, and \$15, respectively.
The firm encounters pricep elasticity in selling the three products sothat the prices required (in dollars) in order to be able to sell $x_1$ , $x_2$ , and $x_3$ units are 
$(35 + 100 x_1^{-\frac{1}{3}} )$, $(15 + 40x^{-\frac{1}{4}})$, and $(20 + 50 x_3^{-\frac{1}{2}}),$, respectively.
