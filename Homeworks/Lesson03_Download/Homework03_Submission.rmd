...
* First, put together a model that looks almost exactly like the mathematical formulation of the problem (see Solutions for Lesson 2 for instance).  This should be in the style of Wyndor2.mod in the Examples download folder.  Upload 3p1a.mod.
